...
trace = open('Code/Traces/backtest_m2.txt', 'w')
...
def main(argv):
    ...
    table = open('Code/Results/backtest_table_m2.txt', 'w')
    ...
    plt.savefig(f'Plots/backtest_m2_inv_{end_strat}_{symmetry}.png', bbox_inches='tight', dpi=100, format='png')
    ...
    plt.grid()
    ax.set_facecolor('#f2f2f2')
    plt.savefig(f'Plots/backtest_m2_pnl_{end_strat}_{symmetry}.png', bbox_inches='tight', dpi=100, format='png')
    ...
    plt.grid()
    ax.set_facecolor('#f2f2f2')
    plt.savefig(f'Plots/backtest_m2_prices_{end_strat}_{symmetry}.png', bbox_inches='tight', dpi=100, format='png')
